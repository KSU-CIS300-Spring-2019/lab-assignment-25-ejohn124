...
namespace Ksu.Cis300.PriorityQueueLibrary
{
    public class MinPriorityQueue<TPriority, TValue> where TPriority : IComparable<TPriority>
    {
        ...
        /// <summary>
        /// Tracks the minimum priority of the leftist tree
        /// </summary>
        ...
        /// </summary>
        /// <returns>Value of minimum priority node</returns>
            ...
            LeftistTree<KeyValuePair<TPriority, TValue>> h2)
        {
            ...
            int compared = h1.Data.Key.CompareTo(h2.Data.Key);
            LeftistTree<KeyValuePair<TPriority, TValue>> newRoot;
            if(compared > 0)
            {
                newRoot = new LeftistTree<KeyValuePair<TPriority, TValue>>(h2.Data, h2.LeftChild, Merge(h1, h2.RightChild));
                
            }
            else
            {
                newRoot = new LeftistTree<KeyValuePair<TPriority, TValue>>(h1.Data, h1.LeftChild, Merge(h2, h1.RightChild));
            }
            return newRoot;
        }
    }
